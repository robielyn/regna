                        ...
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                <form action="announcement.php" method="POST">
                                    <div class="col-xxl-4 col-md-4" style=" padding: 40px; border-radius: 10px; width:100%">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                function countActivity($specifiedMonth)
                                {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $datetimeString = $row['dateOfActivity'];
                                ...
                                ?>
                                <canvas id="barChart" style="max-height: 300px; display: block; box-sizing: border-box; height: 200px; width: 400px;" width="520" height="200"></canvas>
                                <script>
                                    document.addEventListener("DOMContentLoaded", () => {
                                        new Chart(document.querySelector('#barChart'), {
                                            ...
                                            data: {
                                                ...
                                                datasets: [{
                                                    label: 'Bar Chart',
                                                    data: [<?=countActivity(1)?>, <?=countActivity(2)?>, <?=countActivity(3)?>, <?=countActivity(4)?>, <?=countActivity(5)?>, <?=countActivity(6)?>, <?=countActivity(7)?>, <?=countActivity(8)?>, <?=countActivity(9)?>, <?=countActivity(10)?>, <?=countActivity(11)?>, <?=countActivity(12)?>],
                                                    backgroundColor: [
                                                        'rgba(255, 99, 132, 0.2)',
                                                        'rgba(255, 159, 64, 0.2)',
                                                        'rgba(255, 205, 86, 0.2)',
