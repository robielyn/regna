        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-4" style="background-color: #f0f0f0; padding: 20px; border-radius: 10px;">

    <h5 class="card-title" style="font-size: 18px; font-weight: bold; margin-bottom: 10px;">Announcement</h5>

    <textarea id="announcementText" rows="4" cols="50" placeholder="Write your announcement here..."
        style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 14px;"></textarea>

    <button id="submitAnnouncement" type="button" class="btn btn-primary" style="margin-top: 10px;">Submit</button>
